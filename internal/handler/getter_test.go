...
func TestGetter(t *testing.T) {
	...
	TItem(t, hg.HandleMetricGetURL, "http://localhost:8080/value/", w, http.StatusNotFound, "path too short")
	TItem(t, hg.HandleMetricGetURL, "http://localhost:8080/value/ololo/ololo/ololo", w, http.StatusBadRequest, "invalid metric type")
	TItem(t, hg.HandleMetricGetURL, "http://localhost:8080/value/gauge//", w, http.StatusNotFound, "invalid metric name")
	TItem(t, hg.HandleMetricGetURL, "http://localhost:8080/value/gauge/ololo", w, http.StatusNotFound, "mertic not found")
	TItem(t, hg.HandleMetricGetURL, "http://localhost:8080/value/gauge/float64", w, http.StatusOK, "float64 value")
	TItem(t, hg.HandleMetricGetURL, "http://localhost:8080/value/counter/int64", w, http.StatusOK, "int64 value")
